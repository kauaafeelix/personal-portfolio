...
export default function Navbar() {
  return (
    <nav className="sticky top-0 z-50 flex flex-row items-center justify-between p-6 bg-[#020617]/80 shadow-md max-w-full px-[4rem] backdrop-blur-md">
        <div className="w-[200px]">
            <h2 className="hover-underline font-space font-bold justify-start">KAUÃ FELIX</h2>
        </div>
        ...
        <div className="flex gap-10 justify-end items-center w-[200px]">
